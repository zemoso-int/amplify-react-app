  ...
  return (
    ...
    >
      <Flex
        ...
        {...getOverrideProps(overrides, "Logo54318014")}
      >
        <Icon
          width="18px"
          height="18px"
        ...
        <Text
          ...
          whiteSpace="pre-wrap"
          children="Logo"
          {...getOverrideProps(overrides, "Logo54318016")}
        ></Text>
      </Flex>
      <Flex
        gap="40px"
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "Frame 32154318017")}
      >
        <Text
          fontFamily="Inter"
          fontSize="16px"
      ...
      <Flex
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "Frame 32154318022")}
      >
        <Flex
          gap="8px"
          direction="column"
