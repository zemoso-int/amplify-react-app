...
export default function Atomssidemenusettings(props) {
  ...
  return (
    <Flex
      ...
      {...rest}
      {...getOverrideProps(overrides, "Atomssidemenusettings")}
    >
      <View
        width="24px"
        height="24px"
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "settings_black_24dp 1")}
      >
        <Icon
          width="24px"
          height="24px"
          ...
          left="0%"
          right="0%"
          {...getOverrideProps(overrides, "Vector843021")}
        ></Icon>
        <Icon
          width="19.454246520996094px"
          height="20px"
          viewBox={{ minX: 0, minY: 0, width: 19.454246520996094, height: 20 }}
          paths={[
            {
          ...
          left="9.46%"
          right="9.48%"
          {...getOverrideProps(overrides, "Vector843022")}
        ></Icon>
      </View>
    </Flex>
  );
