...
export default function Organismssearchbar(props) {
  ...
  const variants = [
    {
      ...
      variantValues: { variation: "medium" },
    },
    {
      overrides: {
        "Rectangle 10": { width: "200px" },
        "atoms/icons/work": {},
        "Search Skills": {},
        "Group 17": {},
        "atoms/icons/location": {},
        ...
        "atoms/icons/search": { left: "539px" },
        "Group 19": { width: "200px" },
        Organismssearchbar: {},
      },
  ...
  return (
    <Flex
      ...
      {...rest}
      {...getOverrideProps(overrides, "Organismssearchbar")}
    >
      <Flex
        padding="0px 0px 0px 0px"
        width="843px"
